...
// previdência, depois verifique se ela pode aposentar ou não. Nas regras desse programa a pessoa vai precisar ter, 
...
public class Ex04_Aposentadoria {
		...
		public static void main(String[] args) {
			...
			System.out.print("Quanto Tempo de contribuição: ");
			...
			if (podeAposentar) {
				System.out.println("Sim! Você já Pode aposentar.");
			} else {
